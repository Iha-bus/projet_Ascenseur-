...
public class Building {
    ...
    public static void main(String[] args) throws FileNotFoundException {
        ...
        Elevator elevator1 = new ElevatorForAngryPeople(ELEVATOR_CAPACITY, "Dumb 1");
        Elevator elevator2 = new ElevatorForAngryPeople(ELEVATOR_CAPACITY, "Dumb 2");
        Elevator elevator3 = new ElevatorForAngryPeople(ELEVATOR_CAPACITY, "Dumb 3");
        Elevator elevator4 = new ElevatorForAngryPeople(ELEVATOR_CAPACITY, "Dumb 4");
